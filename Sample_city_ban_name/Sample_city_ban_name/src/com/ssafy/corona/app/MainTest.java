...
public class MainTest {
	public static void main(String[] args) {
		...
		VirusMgr vmgr= VirusMgrImpl2.getInstance();
		System.out.println();		
 ...
 //<- 주석 해제 후 작성 : start ////////////////////////////////
		...
		try {
			...
			vmgr.add(new Corona("코로나19", 4, 2));
			vmgr.add(new Corona("코로나18", 2, 2));
			vmgr.add(new Mers(  "메르스14", 7, 1.5));
			vmgr.add(new Corona("코로나17", 3, 2));
			vmgr.add(new Corona("코로나21", 3, 2));
			vmgr.add(new Mers(  "메르스12", 1, 1.5));
			vmgr.add(new Corona("코로나13", 3, 2));
			vmgr.add(new Corona("코로나15", 2, 2));
			vmgr.add(new Mers(  "메르스19", 4, 1.5));
			vmgr.add(new Corona("코로나24", 3, 2));
